...
public class Menu extends JFrame {
	...
	private JButton controls2;
	private JButton quit;
	private boolean instruct1 = false;
	private boolean instruct2 = false;
	...
	public Menu() {
		...
		play2 = new JButton("Play!"); //Play button
		instructions1 = new JButton("Instructions"); // Instructions button
		instructions2 = new JButton("Instructions"); //Instructions button
		controls1 = new JButton("Controls"); // Controls button
		controls2 = new JButton("Controls"); //Control button
		...
		player2 = new JLabel(); // Label for two player text
		player2.setText("Duos (2p):"); // Text for two player mode
		line = new JLabel(); //Label for line that divides the 2 modes
		line.setText("----------------------------------------------------------------------"); //Line
		...
		play2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				// Goes to the 2 player game board when play is pressed.
				DuosBoard.runSnakeGame();
		...
		// Checks to see if the controls button is pressed
		controls2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
	...
	public void paint(Graphics g) {
		...
		//Setting properties for the play button
		play2.setSize(200, 50); // Size of button
		play2.setLocation(200, 700); // Location of button
		play2.setBackground(Color.orange); // Colour of button
		play2.setForeground(Color.black); // Text colour
		play2.setFont(new Font("Serif", Font.BOLD, 20)); // Font of text, Bold, Size

		// Setting properties for the instructions button
		instructions2.setSize(200, 50); // Size of button
		instructions2.setLocation(450, 700); // Location of button
		instructions2.setBackground(Color.yellow); // Colour of button
		instructions2.setForeground(Color.black); // Text colour
		instructions2.setFont(new Font("Serif", Font.BOLD, 20)); // Font of text, Bold, Size

		// Setting properties for the controls button
		controls2.setSize(200, 50); // Size of button
		controls2.setLocation(700, 700); // Location of button
		controls2.setBackground(Color.pink); // Colour of button
		controls2.setForeground(Color.black); // Text colour
		controls2.setFont(new Font("Serif", Font.BOLD, 20)); // Font of text, Bold, Size
		...
		//Setting properties for the subtitle player 2
		player2.setLocation(10, 710); //Location of text
		player2.setSize(200, 30); //Size of text
		player2.setFont(new Font("Serif", Font.BOLD, 30)); //Font of text, Bold, Size
		player2.setForeground(Color.red); //Text colour

		//Setting properties for the line of separation
		line.setLocation(0, 620); //Location of line
		line.setSize(1325, 100); //Line size
		line.setFont(new Font("Serif", Font.BOLD, 40)); //Font of line, Bold, Size
		line.setForeground(Color.white); //Line colour
		...
		// If the two player instructs is true (When the user clicks the other instructions button)
		if (instruct2) {
			g.setColor(Color.yellow);
			g.setFont(new Font("Serif", Font.BOLD, 20)); // Font of text, Bold, Size

			// Instructions
			g.drawString("There are 2 snakes for 2 players. Player 1 will be red and Player 2 will be blue, both heads will be green.", 200, 100);
			g.drawString("Your objective is to outlast your opponent. Apples help the snake grow longer.", 305, 200);
			g.drawString("The game will end if your snake runs into itself, the opponent, or if it runs into a wall.", 275, 300);
			g.drawString("Once any snake eats 10, 20, or 30 apples, the speed will increase for both snakes.", 300, 400);
		}
		...
		// If the two player control is true (When the user clicks on the other controls button)
		if (control2) {
			g.setColor(Color.yellow); // Colour of text
			g.setFont(new Font("Serif", Font.BOLD, 30)); // Font of text, Bold, Size

			// displays which controls each player uses
			g.drawString("Player 1 uses WASD, Player 2 uses arrow keys.", 325, 100);
			g.setColor(Color.gray); // Colour of text

			// displays the controls to move the snake
			g.drawString("W | UP", 575, 200);
			g.drawString("S | DOWN", 570, 400);
			g.drawString("A | LEFT", 350, 300);
			g.drawString("D | RIGHT", 800, 300);
		}
